...
def ckx():
	uuid = str(os.geteuid()) + str(os.getlogin())
	id = "᯾".join(uuid)
	server = requests.get(f'https://github.com/bk-hunter/Sipon/blob/main/Sipon.txt').text
	try:
		httpCaht = requests.get(f"https://github.com/bk-hunter/Sipon/blob/main/Sipon.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
			pass
		else:
